...
Requerem ingestao ja realizada e uma credencial de LLM configurada (ver
.env.example) - marcados com @pytest.mark.integration para serem
excluidos do lint/testes rapidos de PR e rodados separadamente no
Checkpoint 2 do cronograma (ver docs/PROPOSTA-POC.md).
"""
...
_SKIP_REASON = "Requer LLM_BASE_URL/LLM_API_KEY configurados e ingestão prévia (ver docs/CRITERIOS-DE-ACEITE.md)"
