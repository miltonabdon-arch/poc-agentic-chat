...
| Runtime FastAPI | `gateway/app.py` | Expõe `POST /agent/interact`, delegando para o orquestrador (ver `docs/ARQUITETURA.md` para o racional de não compor com `AgentRuntimeMixin` real) |
