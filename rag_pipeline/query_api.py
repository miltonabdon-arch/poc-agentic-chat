...
- Atenção ao achado de validação descrito em docs/INGESTAO.md, seção 7:
  perguntas fora do catálogo não devem "casar" por acidente com o chunk
  mais próximo — ver tests/test_ingestao.py,
  test_consulta_fora_do_catalogo_nao_inventa_resposta, e a discriminação
  entre planos parecidos em test_consulta_discrimina_planos_com_conteudo_parecido.
"""
